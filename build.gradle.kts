...
plugins {
    id("com.indramahkota.build.logic.convention.detekt") version "0.0.4"

    id("com.indramahkota.build.logic.convention.android-config") version "0.0.4"
    id("com.indramahkota.build.logic.convention.android-lib") version "0.0.4" apply false
    id("com.indramahkota.build.logic.convention.android-app") version "0.0.4" apply false

    id("com.indramahkota.build.logic.convention.compose-config") version "0.0.4"
    id("com.indramahkota.build.logic.convention.compose-lib") version "0.0.4" apply false
    id("com.indramahkota.build.logic.convention.compose-app") version "0.0.4" apply false
}
